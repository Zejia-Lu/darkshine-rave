...
public class RaveKTreeFactory {
  ...
  public RaveKTree useVertexFitter(RaveKParticleContainer particles, String parameters) {
    return new RaveKTree(raveJNI.RaveKTreeFactory_useVertexFitter__SWIG_0(swigCPtr, this, RaveKParticleContainer.getCPtr(particles), particles, parameters), true);
  }

  public RaveKTree useVertexFitter(RaveKParticleContainer particles) {
    return new RaveKTree(raveJNI.RaveKTreeFactory_useVertexFitter__SWIG_1(swigCPtr, this, RaveKParticleContainer.getCPtr(particles), particles), true);
  }

  public RaveKTree useVertexFitter(RaveKParticleContainer particles, RaveKConstraint cs, String parameters) {
    return new RaveKTree(raveJNI.RaveKTreeFactory_useVertexFitter__SWIG_2(swigCPtr, this, RaveKParticleContainer.getCPtr(particles), particles, RaveKConstraint.getCPtr(cs), cs, parameters), true);
  }

  public RaveKTree useVertexFitter(RaveKParticleContainer particles, RaveKConstraint cs) {
    return new RaveKTree(raveJNI.RaveKTreeFactory_useVertexFitter__SWIG_3(swigCPtr, this, RaveKParticleContainer.getCPtr(particles), particles, RaveKConstraint.getCPtr(cs), cs), true);
  }

  public RaveKTreeContainer useParticleFitterWithTree(RaveKTreeContainer trees, RaveKConstraint cs, String parameters) {
    return new RaveKTreeContainer(raveJNI.RaveKTreeFactory_useParticleFitterWithTree__SWIG_0(swigCPtr, this, RaveKTreeContainer.getCPtr(trees), trees, RaveKConstraint.getCPtr(cs), cs, parameters), true);
  }

  public RaveKTreeContainer useParticleFitterWithTree(RaveKTreeContainer trees, RaveKConstraint cs) {
    return new RaveKTreeContainer(raveJNI.RaveKTreeFactory_useParticleFitterWithTree__SWIG_1(swigCPtr, this, RaveKTreeContainer.getCPtr(trees), trees, RaveKConstraint.getCPtr(cs), cs), true);
  }
  ...
  public RaveKParticleContainer useParticleFitterWithParticle(RaveKParticleContainer particles, RaveKConstraint cs, String parameters) {
    return new RaveKParticleContainer(raveJNI.RaveKTreeFactory_useParticleFitterWithParticle__SWIG_0(swigCPtr, this, RaveKParticleContainer.getCPtr(particles), particles, RaveKConstraint.getCPtr(cs), cs, parameters), true);
  }

  public RaveKParticleContainer useParticleFitterWithParticle(RaveKParticleContainer particles, RaveKConstraint cs) {
    return new RaveKParticleContainer(raveJNI.RaveKTreeFactory_useParticleFitterWithParticle__SWIG_1(swigCPtr, this, RaveKParticleContainer.getCPtr(particles), particles, RaveKConstraint.getCPtr(cs), cs), true);
  }
